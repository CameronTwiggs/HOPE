...
const imgchange = () => {
  setTimeout(() => {
    bg.style.background =
      "url('./images/homeimg/freeBR2.jpg')no-repeat center center/cover";
    line.style.height = "33px";
    counts.innerText = "01";
  }, 0000);
  setTimeout(() => {
    bg.style.background =
      "url('../images/homeimg/freeBR.jpg')no-repeat center center/cover";
    line.style.height = "66px";
    counts.innerText = "02";
  }, 5000);
  setTimeout(() => {
    bg.style.background =
      "url('./images/homeimg/freeBR3.jpg')no-repeat center center/cover";
